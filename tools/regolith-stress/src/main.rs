//! `regolith-stress` - random-op correctness harness that cross-checks
//! regolith against an in-memory `BTreeMap` reference.
//!
//! ```sh
//! cargo run --release -p regolith-stress -- --num-ops=100000
//! ```
//!
...
fn main() {
    ...
    println!(
        "regolith-stress  ops={}  key_range={}  value_size={}  seed={}",
        ...
        match op {
            ...
            0..=4 => {
                ...
                if let Some(w) = shadow.as_mut() {
                    ...
                    // subset of what's durable in regolith.
                    w.flush().unwrap();
                }
