//! Cross-check between what the host does and what regolith says it does.
//!
//! [`crate::host`] measures each primitive by calling it. `Env`
//! declares the same set through [`regolith::Capabilities`]. This phase
