//! `conformance` - proves a regolith database stores and returns the right
...
//! ```sh
//! # native
//! cargo run -p regolith-wasm-probe --bin conformance -- --dir /tmp/d --phase write
//!
//! # wasm32-wasip1
...
const USAGE: &str = "\
conformance - native/wasm parity harness for regolith
